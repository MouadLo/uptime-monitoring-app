    ...
    if (!err && headerString) {
      ...
      helpers.getTemplate('_footer', data, function (err, footerString) {
        if (!err && footerString) {
          ...
          callback('Cloud not find the footer templates');
        }
      });
    } else {
      callback('Could not find the header templates');
    }
  })
}
...
helpers.interpolate = function (str, data) {
  ...
  // for each key in the data object, insert its value into string a corresponding placeholder
